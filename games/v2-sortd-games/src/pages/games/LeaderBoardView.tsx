...
const LeaderboardView: React.FC<LeaderboardViewProps> = ({ onStartQuiz }) => {
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-5">
          <div className="flex items-center justify-center gap-4 mb-2">
            <div className="inline-flex items-center justify-center w-10 h-10 bg-gradient-to-br from-purple-600 to-indigo-600 rounded-full shadow-lg">
              <Trophy className="text-white" size={24} />
            </div>
            <h1 className=" text-2xl md:text-3xl font-bold text-primary">Leaderboard</h1>
          </div>
          <p className="text-sm text-muted-foreground">
            Compete with the finest minds and climb to the top!
          </p>
        </div>
