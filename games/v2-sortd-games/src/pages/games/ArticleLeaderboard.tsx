...
if(Game === "HeadLine Scramble"){
   
    const stored = localStorage.getItem(SCORE_STORAGE_KEY);
    let scores:  { scramble_accumulated_score: 0 };
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-3">
          <div className="flex items-center justify-center gap-4 mb-2">
            ...
            <h1 className=" text-xl md:text-2xl font-semibold ">{Game} Leaderboard</h1>
          </div>
        ...
        <div className="text-center mb-2">
          ...
          onClick={() => navigate(-1)}
            // onClick={onStartQuiz}
            className="inline-flex items-center gap-3 px-2 py-1 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl hover:from-purple-700 hover:to-indigo-700 transition-all font-medium shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            <Play size={12} />
            Back
          </button>
        ...
        {loading ? (
          <div className="text-center py-12">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl px-4 py-2 shadow-lg border">
              {" "}
              <div className="text-center mb-2">
                {" "}
                ...
                <div className="space-y-1 max-h-96 overflow-y-auto">
                  ...
                  {leaderboardData.user_info &&
                    Object.keys(leaderboardData.user_info).length > 0 && (
                      <div className="px-3 py-1 bg-gradient-to-r from-purple-100 to-indigo-100 dark:from-purple-900/50 dark:to-indigo-900/50 rounded-lg border-2 border-purple-300 dark:border-purple-600 mb-3">
                  ...
                  {leaderboardData.leaderboard.map((entry) => (
                    <div
                      key={entry.user_id}
                      className="flex items-center justify-between px-3 py-1 bg-slate-50 dark:bg-slate-700 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-600 transition-colors"
                    >
                      <div className="flex items-center gap-3">
